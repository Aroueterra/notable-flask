...
def main(input_path, output_path):
    input_path="C:/Users/aroue/Downloads/Documents/@ML/Mozart/testcases/"
    
    output_path="C:/Users/aroue/Downloads/Documents/@ML/Mozart/newout/"
    print(output_path)
    imgs_path = sorted(glob(f'{input_path}/*'))
    for img_path in imgs_path:
        img_name = img_path.split('/')[-1].split('.')[0]
        img_namef = img_name.split('\\')[1]
        print(output_path)
        ts = output_path + img_name + ".txt"
        print(ts)
        #print(img_names)
        out_file = open(output_path + img_namef + ".txt", "w")
